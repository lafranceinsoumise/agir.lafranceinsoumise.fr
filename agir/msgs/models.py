...
class AbstractMessage(BaseAPIResource):
    author = models.ForeignKey(
        "people.Person", on_delete=models.PROTECT, verbose_name="Auteur"
    )
    content = models.TextField("Contenu", max_length=2000)
    image = StdImageField()
...
class SupportGroupMessage(AbstractMessage):
    ...
    linked_event = models.ForeignKey(
        "events.Event", on_delete=models.PROTECT, verbose_name="Événement lié"
    )
